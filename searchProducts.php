...
if(isset($_REQUEST['searchValue'])){
    ...
    $result = $products->searchProducts($sql, $searchValue);
}else{
    die();
}
    ...
    <section id="products">
        <div class="bg-dark py-5">
            <div class="container">
                ...
                <div class="searchbar pb-3 d-flex justify-content-center">
                    <input id="searchValue" name="searchValue" class="rounded w-25 p-2" type="text" placeholder="zoeken">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div id="snippet" class="card border-0 h-100 pb-1 rounded">
                            ...
                            <div class="px-4">
                                ...
                                <p class="text-dark"><?php echo $product['short_desc'];?></p>
            ...
            <div class="container">
                ...
                <div class="row text">
                    ...
                    <div class="col-6 col-md-2">
                        ...
                        <a href="./general.php">Algemene voorwaarden</a>
                    </div>
                </div>
            </div>
        </div>
