...
if($_SESSION['loggedin'] == true){
    ...
    $sql="SELECT id,firstname,lastname,email,created_at FROM users WHERE id = ?";
    $id = $_SESSION['id'];
    $account = $handler->readUser($sql, $id);
    $ordersql = "";
    ...
    <section id="navbar">
        <div class="bg-green pt-lg-1 pt-4">
            <div class="container">
                ...
                <a class="navbarsvg navbaritems ri-account-circle-line active" href="./login.php"></a>
                <a class="navbarsvg navbaritems ri-store-2-line" href="../productpage.php#products"></a>
            </div>
        </div>
    </section>
    <section id="header">
        <div class="bg-image" style="background-image: url('../images/images/martin-woortman-2YZkzSUb6M8-unsplash.jpg');">
            <div class="bg-cover">
                        ...
                        <div class="col-12 col-md-8 text-white text-center">
                            <div class="d-table h-100 w-100">
                                <div class="d-table-cell align-middle">
                                    <h1 class="mb-3"><i>Welkom <span class="highlight"><?=$account['firstname'];?></span></i></h1>
                                    <a href="#mijngegevens" class="btn green">Mijn Gegevens</a>
                                    <a href="#mijnorders" class="btn green mx-2">Mijn Bestellingen</a>
                                    <a class="btn dark mt-3 mt-lg-0" href="./logoutconfirm.php">Uitloggen</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-dark py-5 border-bottom">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-11 col-md-7 col-lg-5 bg-green text-white text-center rounded p-4">
                        <a id="mijngegevens"></a>
                        <h1>Mijn Gegevens</h1>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-12 col-md-7 col-lg-5 text-white pt-2">
                        <div class="row border-bottom mb-3 mt-1">
                            <div class="col-2 col-md-2 col-lg-1 me-3"><p><strong>Naam:</strong></p></div>  
                            <div class="col-1 me-4 me-md-4 me-lg-2"><p><?=$account['firstname'];?></p></div> 
                            <div class="col-1"><p><?=$account['lastname'];?></p></div> 
                        </div>
                        <div class="row border-bottom mb-3">
                            <div class="col-2 col-md-2 col-lg-1 me-3"><p><strong>Email:</strong></p></div>  
                            <div class="col-1"><p><?=$account['email'];?></p></div>
                        </div>
                        <div class="row">
                            <div class="col-8"><p class="mb-1"><strong>Datum van aanmaken:</strong></p></div>
                            <div class="col-12"><p><?=$account['created_at'];?></p></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="myorders">
        <div class="bg-dark py-5">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-7 col-lg-5 text-white pt-2 d-inline-flex">
                        <div class="mx-auto d-inline-flex pt-1">
