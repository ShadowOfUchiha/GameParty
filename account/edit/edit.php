    ...
    <section class="bg-dark text-white">
        <div class="container">
                    ...
                    <?php  foreach($userArray as $row): ?>
                        <form action="./editaccount.php" class="">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="text" name="firstname" value="<?php echo $row['firstname'];?>" id="firstname" autofocus>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2 text-white py-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input class="align-items-center" type="submit" value="Save">
                            </div>
                            <div class="col-2">
