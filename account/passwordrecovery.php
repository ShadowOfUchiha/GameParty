    ...
    <section id="navbar">
        <div class="bg-green pt-lg-1 pt-4">
            <div class="container">
                ...
                <a class="navbarsvg navbaritems ri-store-2-line" href="#"></a>
                ...
                <form action="" class="">
                    ...
                    <div class="row pb-2">
                        <div class="col-6 mx-auto">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input class="w-100" type="password" placeholder="Nieuwe Wachtwoord" id="newpassword" autofocus>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 mx-auto">
                            <div class="row">
                                <div class="col-4 text-white">
                                    <label for="passwordconfirm">Bevestig nieuw wachtwoord</label>
                                </div>
                                <div class="col-6">
                                    <input class="w-100" type="password" placeholder="Nieuwe Wachtwoord" id="passwordconfirm">
                                </div>
                            </div>
                        </div>
                    </div>
