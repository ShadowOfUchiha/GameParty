    ...
    <section id="navbar">
        <div class="bg-green pt-lg-1 pt-4">
            <div class="container">
                ...
                <a class="navbarsvg navbaritems ri-customer-service-line active" href="./contact.php"></a>
                ...
                <div>
                    <form id="productForm" class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="text" name="product_name" placeholder="vrbril" id="productname" autofocus>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2 text-white py-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="ean" name="ean_code" placeholder="ean" id="ean">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2 text-white py-2">
                            ...
                            <div class="col-8">
                                <input type="text" name="photo" placeholder="photo.png" id="photo">
                            </div>
                            <div class="col-2">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="merk" name="brand" placeholder="oculus" id="merk">
                            </div>
                            <div class="col-2">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-2 text-white py-2">
                                <div class="col-12">
                                    <label for="short_desc">beschrijving in het kort</label>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <button onclick="loadPage('./addproduct.php', sendToContent);">voeg product toe</button>
                        </div>
                        <div class="col-2">
                    </div>
                    </div>
