...
include "../../../dbase/productHandler.php";
if(isset($_REQUEST['id'])){
    $id = $_REQUEST['id'];
    $sql= "SELECT * from products WHERE id= ".$id.";";
    $product = new productHandler;
    $productArray= $product->readProducts($sql);
}else{
    exit("je hebt geen id meegegeven jij hoort hier niet te zijn");
}
...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/q4ylnm2k8p66q84o05546h3hz3cd4fij1ditdlqjo3y8l1tk/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        tinymce.init({selector: '#description'});
        tinymce.init({selector: '#short_desc'});
    </script>
...
<body class="bg-dark">
    <section id="navbar">
        <div class="bg-green pt-lg-1 pt-4">
            <div class="container">
                ...
                <a class="navbarsvg navbaritems ri-store-2-line" href="../../productpage.php"></a>
            </div>
        </div>
    </section>
    <section id="login">
                    ...
                    <form id="productForm" class="">
                        <div class="row">
                            ...
                            <div class="col-12 text-white">
                                <h2>Pas Product Aan</h2>
                            </div>
                        </div>   
                </div>
                <?php  foreach($productArray as $row): ?>
                        <div class="row">
                            <div class="col-2 text-white py-2">
                                <label for="productname">Product Naam</label>
                            </div>
                            <div class="col-8">
                                <input type="text" name="product_name" value="<?php echo $row['product_name'];?>" id="productname" autofocus>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2 text-white py-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="ean" name="ean_code" value="<?php echo $row['ean_code'];?>" id="ean">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2 text-white py-2">
                            ...
                            <div class="col-8">
                                <input type="text" name="photo" value="<?php echo $row['photo'];?>" id="photo">
                            </div>
                            <div class="col-2">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="merk" name="brand" value="<?php echo $row['brand'];?>" id="merk">
                            </div>
                            <div class="col-2">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <select name="color" value="<?php echo $row['color'];?>" id="color">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <select name="resolution" value="<?php echo $row['resolution'];?>" id="resolution">
                                    <option value="1920x1080">1920x1080 (full HD)</option>
                                    <option value="1920x720">1920x720</option>
                                    <option value="2048x1080">2048x1080 (2K)</option>
                                    <option value="2160x1200">2160x1200</option>
                                    <option value="2160x1440">2160x1440</option>
                                    <option value="2560x1440">2560x1440 (Quad HD)</option>
                                    <option value="2880x1440">2880x1440</option>
                                    <option value="2880x1600">2880x1600</option>
                                    <option value="2880x1700">2880x1700</option>
                                    <option value="3664x1920">3664x1920</option>
                                    <option value="3840x2160">3840x2160(4K)</option>
                                    <option value="4320x2160">4320x2160</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <select name="platform" value="<?php echo $row['platform'];?>" id="platform">
                        ...
                        <div class="row">
                            <div class="col-2 text-white py-2">
                                <div class="col-12">
                                    <label for="description">beschrijving in het kort</label>
                                </div>
                            </div>
                        
                            <div class="col-8">
                                <textarea name="short_desc" id="short_desc" cols="30" rows="10"><?php echo $row['short_desc'];?></textarea>
                            </div>
                            <div class="col-2">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                        <button onclick="loadPage('./addedit.php?id=<?php echo $row['id'];?>', sendToContent);">Sla op</button>
                        </div>
                    </div>
   ...
   <section id="footer" class="pt-5 bg-dark">
        <div class="bg-green py-4">
            <div class="container">
                <div class="row">
                    <div class="footer-title col-12 col-md-4">
