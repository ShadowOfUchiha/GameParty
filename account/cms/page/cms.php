...
if($_SESSION['loggedin'] == true){
    if($_SESSION['admin'] == true){
        ...
        $pages = $handler->readProducts($sql);
    }else{
        session_destroy();
...
<head>
    ...
    <script>
        tinymce.init({selector: '#pagetext'});
    </script>
            ...
            <div class="row">
                <div>
                    <form id="productForm" class="">
                        <div class="row">
                            ...
                            <div class="col-12 text-white">
                                <h2>Pas Pagina aan</h2>
                            </div>
                        </div>   
                </div>
                        <div class="row">
                            <div class="col-2 text-white py-2">
                                <label for="productname">Pagina</label>
                            </div>
                            <div class="col-8">
                                <select name="pagename" id="pagename">
                                    <?php foreach($pages as $page): ?>
                                        <option value="<?php echo $page['pagename'];?>"><?php echo $page['pagename'];?> </option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-2 text-white py-2">
                                <div class="col-12">
                                    <label for="pagetext">content/tekst</label>
                                </div>
                            </div>
                        
                            <div class="col-8">
                                <textarea name="pagetext"  id="pagetext" cols="30" rows="10"></textarea>
                            </div>
                            <div class="col-2">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <button onclick="loadPage('./editpage.php', sendToContent)">update pagina</button>
                        </div>
                        <div class="col-2">
                    </div>
                    </div>
