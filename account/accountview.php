...
$sql= "SELECT id,firstname,lastname,email,created_at,admin from users;";
$users = new UserHandler;
$userArray= $users->readUsers($sql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
             ...
             <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                        <p><?php if($row['admin'] == 1){ echo "Ja";}elseif($row['admin']== 0){echo "Nee";} ?></p>
                        </div>
                        <div class="col-2">
                        <div><a href="./delete/deletecon.php?id=<?php echo $row['id']?>">Delete</a></div>
                        
                        <div><a href="./edit/edit.php?id=<?php echo $row['id']?>">Edit</a></div>
                        </div>
