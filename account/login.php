    ...
    <section id="navbar">
        <div class="bg-green pt-lg-1 pt-4">
            <div class="container">
                ...
                <a class="navbarsvg navbaritems ri-account-circle-line active" href="../account/login.php"></a>
                        ...
                        <div class="col-12 col-lg-6 mx-auto">
                            <div class="row">
                                ...
                                <div class="col-7 col-md-6 col-lg-6">
                                    <input class="w-100" type="email" placeholder="voorbeeld@gmail.com" name="email" id="email" autofocus required>
                                </div>
                            </div>
                        </div>
                    </div>
