...
if(isset($_REQUEST['id'])){
    $id = $_REQUEST['id'];
    $sql = "SELECT id,product_name,price,photo,description,ean_code,short_desc FROM products WHERE id= ?;";
    $product = new productHandler;

    $productArray = $product->readProduct($sql, $id);
...
<head>
    ...
    <title><?php echo $productArray[0]['product_name'];?></title>
</head>
<body>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-12 col-lg-5 me-lg-5">
                        <div class="product-img h-100 mb-3 mb-lg-0" style="background-image: url('./images/vr/<?php echo $productArray[0]['photo'];?>');"></div>
                    </div>
                    <div class="col-12 col-md-12 col-lg-5 text-white">
                        <h1 class="border-bottom pb-2 mb-2"><?php echo  $productArray[0]['product_name'];?></h1>
                        <h4 class="pb-4">€ <?php echo $productArray[0]["price"];?>,-</h4>

                        <p>Calender en knop hieronder een echo van het is gelukt</p>

                        <button onclick="loadPage('./cartcontroller.php', sendToContent, <?php echo $productArray[0]['id'];?>, 'add'), cartAlert()" class="btn green w-100 mb-3">In mijn winkelwagen</button>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12 text-white pt-3 d-inline-flex">
                                <div class="d-inline-flex">
                                    <ul>
                                        <li class="mb-1">Gratis binnen 30 dagen te retourneren</li>
                                        <li class="mb-1">3 jaar garantie op je VR bril</li>
                                        <li class="mb-1">Klantbeoordeling 9,2/10</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row px-lg-4 mx-lg-5 py-md-5 py-4">
                    ...
                    <p>
                    <?php if (!empty($productArray[0]["description"])) {
                        echo $productArray[0]["description"];
                    } else { 
                        echo $productArray[0]["short_desc"];
                    } ?>
                    <p>
                    </div>
                </div>
        ...
        <div class="bg-green py-4">
            <div class="container">
                ...
                <div class="row text">
                    ...
                    <div class="col-6 col-md-2">
                        <a href="./account/accountview.php">Account</a><br>
